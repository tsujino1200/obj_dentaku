    ...
    for(int i = 0 ; i < buttons.length ; i++) {
      if(buttons[i].isClicked(mx, my)) {
        ...
        if(label.equals("=")) {
          ...
          //"*"部分の省略表記の回避
          if(last.equals(")") || last.equals("0") || last.equals("1") || last.equals("2") || last.equals("3") || last.equals("4") 
          || last.equals("5") || last.equals("6") || last.equals("7") || last.equals("8") || last.equals("9") || last.equals("π")) {
